	...
	return (
		<section className="flex grow">
			...
			<div className="grow flex flex-col items-center justify-between lg:flex-row lg:items-center lg:justify-between ">
				<div className="flex flex-col items-center lg:items-start  mx-6 mt-12 md:mt-20 lg:ml-32 lg:mx-0 lg:mt-0 lg:mb-0 lg:h-52">
					...
					<h2 className="text-[75px] text-center lg:text-left md:text-[100px] font-belle text-white underline decoration-green-600">
						ARTIS FLOOR
					</h2>
					<TextAnimation />
				</div>
